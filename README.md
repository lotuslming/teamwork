...
离线或内网部署可参考 `docs/OFFLINE_DEPLOY.md`，其中已经把本地 AI 服务和 OnlyOffice 的配置关系收口。
...
| `OPENAI_MODEL` | AI 模型名 | `gpt-3.5-turbo` |
| `ONLYOFFICE_URL` | OnlyOffice 服务地址 | `http://localhost:8080` |
| `ONLYOFFICE_JWT_SECRET` | OnlyOffice JWT 密钥 | `teamwork-onlyoffice-secret-key` |
| `INTERNAL_URL` | OnlyOffice 回调应用的内网地址 | `http://172.17.0.1:5000` |
